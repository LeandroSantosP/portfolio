      ...
      <div className="md:col-span-7 flex flex-col justify-start gap-6">
        ...
        <div className="flex gap-4 items-center">
          ...
          <div className="hidden md:flex items-center gap-3">
            <a className="w-10 h-10 rounded-full border border-outline-variant flex items-center justify-center hover:bg-primary hover:text-on-primary transition-colors" href="https://github.com/LeandroSantosP" target="_blank" rel="noreferrer noopener" aria-label="GitHub">
            ...
            <a
              className="inline-flex items-center gap-2 border border-outline-variant text-primary px-6 py-3 rounded-lg font-label-md text-label-md hover:bg-surface-container transition-colors whitespace-nowrap"
