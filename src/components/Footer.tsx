      ...
      <div className="w-full py-xl px-gutter max-w-container-max mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex items-center gap-6">
          <nav className="flex gap-3">
            {/* Circular icon link */}
            <a className="w-10 h-10 rounded-full border border-outline-variant flex items-center justify-center hover:bg-primary hover:text-on-primary transition-colors" href="https://github.com/LeandroSantosP" target="_blank" rel="noreferrer" aria-label="GitHub">
            ...
            <a className="w-10 h-10 rounded-full border border-outline-variant flex items-center justify-center hover:bg-primary hover:text-on-primary transition-colors" href="https://www.linkedin.com/in/leandro-p-dos-santos" target="_blank" rel="noreferrer noopener" aria-label="LinkedIn">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden>
            ...
            <a className="w-10 h-10 rounded-full border border-outline-variant flex items-center justify-center hover:bg-primary hover:text-on-primary transition-colors" href="mailto:skp.Tridimensional@gmail.com" target="_blank" rel="noreferrer noopener" aria-label="Email">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden>
          ...
          <a
            className="inline-block border border-outline-variant text-primary px-4 py-2 rounded-lg font-label-md text-label-md hover:bg-surface-container hover:text-on-primary transition-colors whitespace-nowrap"
        ...
        <p className="font-body-md text-body-md text-on-secondary-container dark:text-secondary-fixed-dim">© 2026 DevPortfolio. Todos os direitos reservados.</p>
      </div>
    </footer>
  )
}
